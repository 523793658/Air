	...
	"targets":[
		{
			...
			"sources":[
				...
				"../rendersystem/include/ForwardShadingRenderer.hpp",
				"../rendersystem/include/UniformBuffer.hpp",
				"../rendersystem/include/RenderResource.hpp",
				"../rendersystem/include/HardwareResource.hpp",
				"../rendersystem/include/ShaderParameters.hpp",
				"../rendersystem/include/RenderDefinitions.hpp",
				"../rendersystem/include/DynamicRHI.hpp",
				"../rendersystem/include/SceneRenderTarget.hpp",
				"../rendersystem/include/TaskGraphInterfaces.hpp",
				"../rendersystem/include/RenderTargetPool.hpp",
				"../rendersystem/include/SceneManagerment.hpp",
				"../rendersystem/include/SceneViewExtension.hpp",
				"../rendersystem/include/CommandList.inl",
				"../rendersystem/include/ShowFlags.hpp",
				"../rendersystem/include/SceneUtil.hpp",
				...
				"../rendersystem/src/ForwardShadingRenderer.cpp",
				"../rendersystem/src/UniformBuffer.cpp",
				"../rendersystem/src/RenderResource.cpp",
				"../rendersystem/src/HardwareResource.cpp",
				"../rendersystem/src/ShaderParameters.cpp",
				"../rendersystem/src/RenderDefinitions.cpp",
				"../rendersystem/src/DynamicRHI.cpp",
				"../rendersystem/src/SceneRenderTarget.cpp",
				"../rendersystem/src/TaskGraphInterfaces.cpp",
				"../rendersystem/src/RenderTargetPool.cpp",
				"../rendersystem/src/SceneManagerment.cpp",
				"../rendersystem/src/SceneViewExtension.cpp",
				"../rendersystem/src/ShowFlags.cpp",
				"../rendersystem/src/SceneUtil.cpp",
